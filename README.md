...
## Download: [BetterNarrow-1.1.6a.zip](https://github.com/Laamy/betternarrow/releases/download/1.1.6a/BetterNarrow-1.1.6a.zip)
...
<h3 align="center">If BetterNarrow doesn't start, refresh the page and wait the game to fully load.</h3>
