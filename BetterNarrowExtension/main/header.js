 ...
 */
var __requirejs, __require, define;
! function(global, setTimeout) {
    ...
    if (void 0 === define) {
        if (void 0 !== __requirejs) {
            if (isFunction(__requirejs)) return;
            cfg = __requirejs, __requirejs = void 0
        }
        void 0 === __require || isFunction(__require) || (cfg = __require, __require = void 0), req = __requirejs = function(e, t, i, r) {
            var n, o, a = defContextName;
            return isArray(e) || "string" == typeof e || (o = e, isArray(t) ? (e = t, t = i, i = r) : e = []), o && o.context && (a = o.context), (n = getOwn(contexts, a)) || (n = contexts[a] = req.s.newContext(a)), o && n.configure(o), n.__require(e, t, i)
            ...
            e()
        }, __require || (__require = req), req.version = version, req.jsExtRegExp = /^\/|:|\?|\.js$/, req.isBrowser = isBrowser, s = req.s = {
            contexts: contexts,
            newContext: newContext
        }, req({}), each(["toUrl", "undef", "defined", "specified"], function(t) {
            req[t] = function() {
                var e = contexts[defContextName];
                return e.__require[t].apply(e, arguments)
            }
            ...
            "string" != typeof e && (t = i, i = e, e = null), isArray(i) || (t = i, i = null), !i && isFunction(t) && (i = [], t.length && (t.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function(e, t) {
                i.push(t)
            }), i = (1 === t.length ? ["__require"] : ["__require", "exports", "module"]).concat(i))), useInteractive && (r = currentlyAddingScript || getInteractiveScript()) && (e || (e = r.getAttribute("data-requiremodule")), n = contexts[r.getAttribute("data-requirecontext")]), n ? (n.defQueue.push([e, i, t]), n.defQueueMap[e] = !0) : globalDefQueue.push([e, i, t])
        }, define.amd = {
            jQuery: !0
    ...
    function newContext(u) {
        ...
        function w(e) {
            ...
            if (t && isArray(t) && 1 < t.length) return t.shift(), l.__require.undef(e), l.makeRequire(null, {
                skipMap: !0
            })([e]), !0
        }
        ...
        return c = {
            __require: function(e) {
                return e.__require ? e.__require : e.__require = l.makeRequire(e.map)
            },
            exports: function(e) {
                        ...
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(o)) {
                                    ...
                                    if (this.map.isDefine && void 0 === n && ((e = this.module) ? n = e.exports : this.usingExports && (n = this.exports)), t) return t.requireMap = this.map, t.requireModules = this.map.isDefine ? [this.map.id] : null, t.requireType = this.map.isDefine ? "define" : "__require", O(this.error = t)
                                } else n = o;
            ...
            configure: function(e) {
                ...
                }), (e.deps || e.callback) && l.__require(e.deps || [], e.callback)
            },
